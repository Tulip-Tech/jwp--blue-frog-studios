  ...
  return (
    <div className={styles.policyContainer}>
      ...
      <div className={styles.termsContent}>
        ...
        <p>
          <strong>1. Introduction:</strong> We are responsible for maintaining and protecting the Personal Information under our control. We have designated an
          individual or individuals who is/are responsible for compliance with our privacy policy.
        </p>
        ...
        <p>
          <strong>3. Consent:</strong> Knowledge and consent are required for the collection, use or disclosure of Personal Information except where required or
        ...
        <p>
          <strong>4. Limiting Collection:</strong> The Personal Information collected will be limited to those details necessary for the purposes identified by
        ...
        <p>
          <strong>5. Limiting Use, Disclosure and Retention:</strong> Retention: Personal Information may only be used or disclosed for the purpose for which it
          was collected unless you have otherwise consented, or when it is required or permitted by law. Personal Information will only be retained for the
        ...
        <p>
          <strong>9. Customer Access:</strong> Upon request, you will be informed of the existence, use and disclosure of your Personal Information, and will be
          given access to it. You may verify the accuracy and completeness of your Personal Information, and may request that it be amended, if appropriate.
        ...
        <p>
          <strong>10. Handling Customer Complaints and Suggestions:</strong> You may direct any questions or inquiries with respect to our privacy policy or our
      ...
      <div className={styles.privacyContent}>
        ...
        <p>
          ...
          <br />
          <br /> <strong>Bluefrogplus.com</strong> uses various types of cookies, each serving a specific purpose. For further information about cookies and how
        ...
        <p>
          ...
          enhance your website experience and for statistical purposes. Performance cookies collect anonymous data about how users interact with the site. This
          includes information like which pages are visited most frequently, whether communications we send are opened, which ads are viewed or interacted with,
          and whether error messages are encountered. The data collected helps us improve the user experience, track statistics, or offer personalized content
          based on what we believe you might be interested in. These cookies do not collect personal information unless you are a registered user, in which case
          the information may be linked to your account. <br />
        ...
        <p>
          ...
          <br /> When you see the Ad Choices icon on advertisements, you can click on it to learn more about behaviorally targeted advertising and how to manage
        ...
        <p>
          ...
          <br />
          Bluefrogplus.com (or service providers acting on our behalf) may place targeted advertising cookies on your device. These cookies help us recognize if
          you have interacted with our content or ads, so we can show you more relevant advertisements. These cookies can also limit how often you see the same
          ad. While the information collected is anonymous, if you have a registered account, we may associate it with your account to provide more targeted
          advertising.
        </p>
        <p>
          <br />
      ...
      <br />
      <p>
        You can manage cookies and tracking technologies in several ways through your browser settings. You can accept or decline cookies or set your browser to
        alert you before accepting a cookie from any website. Keep in mind that disabling cookies may prevent some features from functioning properly. <br />
      ...
      <br />
      <p>
        To manage cookies, you can configure your browser not to accept them, and you can delete cookies using the steps provided above. However, some features
        of our website may not work as expected if you disable cookies.
      </p>
    </div>
  );
};
