        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.socialIcons}>
              <a target="_blank" rel="noreferrer" href="https://www.facebook.com/BlueFrogLive" className={styles.socialIcon}>
                <Facebook size={18} />
              </a>
              <a target="_blank" rel="noreferrer" href="https://www.instagram.com/bluefrogstudios" className={styles.socialIcon}>
                <Instagram size={18} />
              </a>
              <a target="_blank" rel="noreferrer" href="https://x.com/bluefroglive" className={styles.socialIcon}>
                <Twitter size={18} />
              </a>
              <a target="_blank" rel="noreferrer" href="https://www.youtube.com/@bluefrogstudios" className={styles.socialIcon}>
                <Youtube size={18} />
              </a>
            </div>
